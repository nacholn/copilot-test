  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'system-ui' }}>
      ...
      <ul>
        ...
        <li><strong>POST /api/auth/recover</strong> - Recover password</li>
        <li><strong>GET /api/profile?userId=...</strong> - Get user profile</li>
        <li><strong>PATCH /api/profile?userId=...</strong> - Update user profile</li>
      </ul>
    </main>
  );
}
